...
dda_model <-lm_robust(sadda~qct+yr_alloc+non_prof+trgt_pop+trgt_fam+trgt_eld+trgt_hml+nine_prcnt , data = lihtc, fixed_effects = proj_st)

modelsummary(dda_model, stars = TRUE)
```
...
modelsummary(qct_model, stars = TRUE)
